        ...
        <div className="flex flex-1 flex-col gap-3 p-4">
          <div className="flex-1 space-y-1.5">
            <button
              ...
              className="text-left"
            >
              <h3 className="text-stencil text-base font-bold text-foreground line-clamp-1 transition-colors hover:text-primary">
                {product.name}
              </h3>
            </button>
            ...
            <button
              ...
              className={cn(
                ...
                canAdd
                  ...
                  : "bg-muted/60 text-muted-foreground/70 cursor-not-allowed text-[11px] font-medium normal-case tracking-normal",
              )}
            >
              {isInformational ? (
                <>
